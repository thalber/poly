...
public static partial class Utils {
	...
	public static LUA.DynValue ToTableDyn(this LUA.DynValue[] values, LUA.Script owner) => LUA.DynValue.NewTable(owner, values);
	[JIT.MethodImpl(JIT.MethodImplOptions.AggressiveInlining)]
	public static LUA.DynValue TableDyn(LUA.Script owner, params LUA.DynValue[] values) => LUA.DynValue.NewTable(owner, values);
	[JIT.MethodImpl(JIT.MethodImplOptions.AggressiveInlining)]
	public static LUA.DynValue ToTupleDyn(this LUA.DynValue[] values) => LUA.DynValue.NewTuple(values);
	[JIT.MethodImpl(JIT.MethodImplOptions.AggressiveInlining)]
	public static LUA.DynValue TupleDyn(params LUA.DynValue[] values) => LUA.DynValue.NewTuple(values);
	[JIT.MethodImpl(JIT.MethodImplOptions.AggressiveInlining)]
	public static LUA.DynValue ToStrDyn(this string s) => LUA.DynValue.NewString(s);
	[JIT.MethodImpl(JIT.MethodImplOptions.AggressiveInlining)]
	public static IEnumerable<LUA.DynValue> Iter(this LUA.CallbackArguments args) {
		for (int i = 0; i < args.Count; i++) yield return args[i];
	}
	#endregion
}
